...
const rotateR = [0, 4.71, 0]
  ...
  return (
    <group>
      ...
      {/* Props */}
      <group>
        <TreeFinal    pos={[15, -1, -68]}
                hitboxPos={[28, 0, -128]}/>

        <TreeFinal    pos={[15, -1, -66]}
                hitboxPos={[28, 0, -126]}/>

        <StreetLightFinal pos={[9, -1, -50]} rotate={rotateL}
                    hitboxPos={[22, 0, -110]} />
        ...
        <TreeFinal    pos={[53, -1, -30]}
                hitboxPos={[66, 0, -90]}/>

        <TreeFinal    pos={[61, -1, -30]}
                hitboxPos={[74, 0, -90]}/>
